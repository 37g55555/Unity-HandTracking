...
namespace ShadowPrototype
{
    public class ExhibitionFlowController : MonoBehaviour
    {
        ...
        private string handTrackingArguments = string.Empty;
            ...
            HandLandmarkUdpReceiver udpReceiver)
        {
            ...
            {
                captureWorkingDirectory = Path.Combine(userHome, "Downloads", "CAP2");
            }

            if (string.IsNullOrWhiteSpace(handTrackingWorkingDirectory))
            {
                handTrackingWorkingDirectory = Path.Combine(userHome, "Downloads", "CAP2");
            }
        ...
        private void Update()
        {
            ...
            CheckProcessExit(ref extractProcess, "ExtractMesh");

            if (Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.KeypadEnter))
            {
                ShadowMeshExtraction();
            }
        }
