...
{
    public class ShadowMeshDeformationSlider : MonoBehaviour
    {
        private const string CanvasName = "DeformationSliderCanvas";
        private const int LandmarksPerHand = 21;
        private const int ThumbTipIndex = 4;
        private const int MiddleTipIndex = 12;
        private const float MinAffectedRadius = 0.12f;
        private const float MaxAffectedRadius = 0.65f;
        private const float StartingAffectedRadius = 0.3f;
        private static readonly Vector2 PanelSize = new Vector2(58.0f, 300.0f);
        private static readonly Vector2 PanelOffset = new Vector2(-34.0f, 0.0f);
        ...
        private const float SliderGrabPaddingPixels = 90.0f;
        private const float HandSliderSmoothingSpeed = 14.0f;
