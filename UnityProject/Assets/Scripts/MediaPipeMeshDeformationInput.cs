...
namespace ShadowPrototype
{
    public class MediaPipeMeshDeformationInput : MonoBehaviour
    {
        ...
        [SerializeField] private float trackedFrameWidth = 640.0f;
        [SerializeField] private float trackedFrameHeight = 480.0f;

        [Header("Selection")]
        [SerializeField] private float hoverSnapDistanceLocal = 0.35f;
        ...
        private bool loggedFirstProjection;
        ...
        private void Update()
        {
            ...
            {
                Debug.Log($"MediaPipe deformation input received hand data. Index local={IndexLocalPoint}, thumb local={ThumbLocalPoint}.");
